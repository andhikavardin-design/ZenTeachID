...
<head>
    <meta charset="UTF-8">
    <title>Beranda Admin - ZenTechID</title>
    ...
    .welcome-section {
        background: linear-gradient(45deg, #00c2ff, #005a7f);
        padding: 60px;
        border-radius: 15px;
        margin-bottom: 40px;
...
<header>
    ...
    <nav>
        ...
        <a href="{{ route('admin.foto_profil') }}" class="nav-icon profile-icon">
...
<div class="main-content">
    <div class="welcome-section">
        ...
        <p>Ini adalah halaman beranda untuk panel admin ZenTechID. Anda memiliki kontrol penuh atas semua produk, promosi, dan data pengguna.</p>
    </div>
    ...
    <a href="{{ route('admin.promosi.index') }}" class="view-all-btn">Lihat Semua Promosi</a>
</div>
